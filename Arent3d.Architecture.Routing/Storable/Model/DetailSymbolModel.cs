namespace Arent3d.Architecture.Routing.Storable.Model
{
  public class DetailSymbolModel
  {
    ...
    public DetailSymbolModel( string? detailSymbolId, string? detailSymbol, string? conduitId, string? fromConnectorId, string? toConnectorId, string? code, string? lineIds )
    {
