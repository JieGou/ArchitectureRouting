...
namespace Arent3d.Architecture.Routing.Storable.StorableConverter
{
  ...
  public class CeedModelStorableConvert : StorableConverterBase<CeedModel>
  {
    ...
    protected override CeedModel Deserialize( Element storedElement, IDeserializerObject deserializerObject )
    {
      ...
      return new CeedModel( legendDisplay!, ceedModelNumber!, ceedSetCode!, generalDisplayDeviceSymbol!, modelNumber!, floorPlanSymbol!, instrumentationSymbol!, name!, base64InstrumentationImageString!, base64FloorPlanImages!, floorPlanType! ) ;
    }
  }
}
