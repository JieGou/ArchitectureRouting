...
namespace Arent3d.Revit.Csv
{
  internal class UnitDictionary
  {
    ...
    private readonly Dictionary<string, ForgeTypeId> _dic = new() ;
    private readonly Dictionary<ForgeTypeId, string> _reverseDic = new() ;
    ...
    public UnitDictionary( IEnumerable<KeyValuePair<string, ForgeTypeId>> dic )
    {
      AddUnits( dic ) ;
    }

    public void AddUnit( string unitName, ForgeTypeId unitTypeId )
    {
    ...
    public void AddUnits( IEnumerable<KeyValuePair<string, ForgeTypeId>> dic )
    {
    ...
    public (double Value, ForgeTypeId? Unit)? Match( string text )
    {
    ...
    public string GetValueWithUnit( double value, ForgeTypeId unitTypeId )
    {
