#region Copyright
// Copyright (C) 2010-2016 by Autodesk, Inc.
//
...
namespace IntroCs
{
  ...
  [Arent3d.Revit.RevitAddin( "{4C98357D-4D5B-4F92-B224-BCECBD37D4B7}" )]
  ...
  [Arent3d.Revit.RevitAddin( "{F14F974D-F1DB-4AF9-8B4D-3FD43495ACC5}" )]
  [DisplayName( "Hello World (Simple)" )]
  ...
  /// </summary>
  [Arent3d.Revit.RevitAddin( "{332CABE3-5A09-45CB-A55B-0ECBC895EA34}" )]
  ...
  /// </summary>
  [Transaction( TransactionMode.ReadOnly )]
  [Arent3d.Revit.RevitAddin( "{E3A99558-282D-4E65-B9AB-6CAA2D0C1AB1}" )]
