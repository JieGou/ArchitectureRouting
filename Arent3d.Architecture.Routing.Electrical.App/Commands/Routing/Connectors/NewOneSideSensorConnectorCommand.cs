...
namespace Arent3d.Architecture.Routing.Electrical.App.Commands.Routing.Connectors
{
  ...
  [DisplayNameKey( "Electrical.App.Commands.Routing.NewConnectorTypeSensorCommand", DefaultString = "New One Side Sensor Connector" )]
  [Image( "resources/new_connector_02.png" )]
  public class NewConnectorTypeSensorCommand : NewConnectorCommandBase
  {
