...
namespace Arent3d.Architecture.Routing.AppBase.Forms
{
  public partial class SelectedFromToBaseDialog : UserControl
  {
        ...
        {
            [ AvoidType.Whichever ] = "Dialog.Forms.SelectedFromToBaseDialog.ProcessConstraints.None".GetAppStringByKeyOrDefault( "Whichever" ),
            [ AvoidType.NoAvoid ] = "Dialog.Forms.SelectedFromToBaseDialog.ProcessConstraints.NoPocket".GetAppStringByKeyOrDefault( "Don't avoid From-To" ),
            [ AvoidType.AvoidAbove ] = "Dialog.Forms.SelectedFromToBaseDialog.ProcessConstraints.NoDrainPocket".GetAppStringByKeyOrDefault( "Avoid on From-To" ),
            [ AvoidType.AvoidBelow ] = "Dialog.Forms.SelectedFromToBaseDialog.ProcessConstraints.NoVentPocket".GetAppStringByKeyOrDefault( "Avoid below From-To" ),
        };
